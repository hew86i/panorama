...
(function ($) {
    ...
    function createColorPicker() {
        ...
        $("body").append(('<div style="position:absolute; z-index: 10008;" id="mlColorPicker"><div id="mlSelectedColorDiv"></div><input id="mlSelectedColorText" type="text" maxlength="6"><div id="mlCloseColorDiv">x</div><div id="mlColors"></div></div>'))
