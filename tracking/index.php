...
-->
	...
	<link rel="stylesheet" href="pinIcons.css">
...
<?php
	...
	$_SESSION['emailflag'] = dlookup("select emailflag from users where id=" . session("user_id"));
	...
	$dsVehicles = query("select cast(code as integer), registration, organisationid, id, gsmnumber from vehicles where id in (".$sqlV.") order by code");
...
<div id="div-Add-Group" style="display: none;" title="<?php echo dic("Tracking.AddGroup")?>">
    ...
    <table id="tblIconsPOI" border="0" style="width: 268px; text-align: center; position: relative; top: -10px; left: -15px;">
        <tr>
        	<td>
        		<i id="GroupIconImg0" class="iconpin icon-poi-0"></i>
    		</td>
    		<td>
        		<i id="GroupIconImg1" class="iconpin icon-poi-1"></i>
        	</td>
    		<td>
        		<i id="GroupIconImg2" class="iconpin icon-poi-2"></i>
    		</td>
    		<td>
        		<i id="GroupIconImg3" class="iconpin icon-poi-3"></i>
        	</td>
    		<td>
        		<i id="GroupIconImg4" class="iconpin icon-poi-4"></i>
        	</td>
        	<td>
        		<i id="GroupIconImg5" class="iconpin icon-poi-5"></i>
        	</td>
        	<td>
        		<i id="GroupIconImg6" class="iconpin icon-poi-6"></i>
        	</td>
        	<td>
        		<i id="GroupIconImg7" class="iconpin icon-poi-7"></i>
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg8" class="iconpin icon-poi-8"></i>
        	</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg9" class="iconpin icon-poi-9"></i>
    		</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg10" class="iconpin icon-poi-10"></i>
        	</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg11" class="iconpin icon-poi-11"></i>
        	</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg12" class="iconpin icon-poi-12"></i>
        	</td>
        	<td style="padding-top: 20px">
        		<i id="GroupIconImg13" class="iconpin icon-poi-13"></i>
        	</td>
        	<td style="padding-top: 20px">
        		<i id="GroupIconImg14" class="iconpin icon-poi-14"></i>
        	</td>
        	<td style="padding-top: 20px">
        		<i id="GroupIconImg15" class="iconpin icon-poi-15"></i>
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg16" class="iconpin icon-poi-16"></i>
        	</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg17" class="iconpin icon-poi-17"></i>
        	</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg18" class="iconpin icon-poi-18"></i>
        	</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg19" class="iconpin icon-poi-19"></i>
        	</td>
        	<td style="padding-top: 20px">
        		<i id="GroupIconImg20" class="iconpin icon-poi-20"></i>
        	</td>
        	<td style="padding-top: 20px">
        		<i id="GroupIconImg21" class="iconpin icon-poi-21"></i>
    		</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg22" class="iconpin icon-poi-22"></i>
    		</td>
    		<td style="padding-top: 20px">
        		<i id="GroupIconImg23" class="iconpin icon-poi-23"></i>
        	</td>
    	</tr>
    	<tr>
...
<div id="div-Add-POI" style="display: none;">
	...
	<table style="font-size: 11px; color: rgb(65, 65, 65); font-family: Arial,Helvetica,sans-serif; margin-left: 20px;" cellpadding="0" cellspacing="0" border="0">
    	...
    	<tr>
    		...
    		<td>
    			<dl id="poiGroup" class="dropdown" style="width: 212px; position: relative; float: left; padding: 0px; margin: 0px;">
			    <?php
	...
	<div align = "center">
 		<table cellpadding="3" width="100%" style="font-size: 11px">
			...
			<tr>
				...
				<td width = "75%" style="font-weight:bold" class ="text2">
					<dl id="gfGroup" class="dropdown" style="width: 210px; position: relative; float: left; margin: 0px;">
				    <?php
...
pass_strength = '<?php echo $_SESSION["pass_strength"]; ?>';
cntAfterLogin = '<?php echo $_SESSION["cntAfterLogin"]; ?>';
email_flag = '<?php echo $_SESSION["email_flag"]; ?>';
...
var buttonOkStatus = 0;  // za ok kopceto da iskluci ako vednas se klikne
	...
	if(Number('<?php echo $_SESSION["emailflag"] ?>') === 0 && '<?php echo $_SESSION["cntAfterLogin"]?>' == false){
	  $(function() {
	...
	// })
 	...
 	if (Number(pass_strength) < 6 && cntAfterLogin == false ) {
