...
function UpdateArea(_n, pts, _areaid, _avail, _gfgid, _col) {
    ...
    $.ajax({
        url: "AddAreaNew.php?id=" + _areaid + '&p=' + ptsNew + '&n=' + _n + '&avail=' + _avail + '&gfgid=' + _gfgid + '&e=' + em + '&ph=' + ph + '&l=' + lang + '&alvl=' + alVl + '&aliz=' + alIz + '&sidx=' + sIdx + '&oeid=' + oEid + '&selveh=' + selVeh,
        context: document.body,
        success: function (data) {
            var dat = data.split("&&@^");
...
function SavingNewArea(pts) {
    ...
    if (pts.length > 1500)
        ...
        ptsNew = pts;
    var _utl = 'n=' + areaName + '&avail=' + avail + '&ppgid=' + $('#gfGroup dt a')[0].title + '&e=' + em + '&ph=' + ph + '&p=' + ptsNew + '&l=' + lang + '&alvl=' + alVl + '&aliz=' + alIz + '&sidx=' + sIdx + '&oeid=' + oEid + '&selveh=' + selVeh;

	$.ajax({
        url: "AddAreaTemp.php?" + _utl,
        context: document.body,
        success: function (data) {
            var dat = data.split("&&@^");
