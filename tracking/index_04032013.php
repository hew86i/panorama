...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="position: relative; z-index: 10;">
	<tr>
		...
		<td width="50%" height="32px" style="background-image:url(../images/traka.png); border-bottom:1px solid #999" align="right" class="text2" valign="middle">
			...
			<img src="../images/sep.png" border="0" style="display: none" align="absmiddle" />&nbsp;&nbsp;
			<!--a>
			...
			<a id="icon-alert" style="position: relative; left: 15px; margin-left: -10px; display: none;">
				<img src="../images/user.png" onclick="ShowHideAlerts()" border="0" align="absmiddle" style="cursor: pointer;" />
