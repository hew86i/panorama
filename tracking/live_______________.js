...
function MoveMarker(_vehicleNo, newLon, newLat, _color, map0, map1, map2, map3, _dt, _status, _speed) {
    for (var i = 0; i < Vehicles.length; i++) {
        for (var j = 0; j < 4; j++) {
            Timers[j] = [];
            if (Boards[j] != null) {
...
function MoveMarkerBack(_vehicleNo, newLon, newLat, _color, map0, map1, map2, map3, _dt, _status, _speed) {
    for (var i = 0; i < Vehicles.length; i++) {
        for (var j = 0; j < 5; j++) {
            Timers[j] = [];
            if (Boards[j] != null) {
