    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(_num == 1)
            {
				...
				//trajectoryslider
				$('#trajectoryslider').mousemove(function (event) { ShowPopup(event, 'Должина на траекторија во минути<br>Над ' + traektorija + ' минути, можен е избор само на едно возило') });
