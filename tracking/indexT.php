...
#top1 {position:absolute; left:220px; top:0px; width:80%; height:5px; border:0px solid #000000; z-index:8000}
...
-->
	...
	<script type="text/javascript" src="./liveTemp.js"></script>
	<script type="text/javascript" src="./live1Temp.js"></script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="position: relative; z-index: 10;">
	<tr>
		<td width="35%" height="32px" style="background-image:url(../images/traka.png); border-bottom:1px solid #999">
			...
			<a id="icon-route" onclick="<?php echo $routes?>" href="../routes/?l=<?php echo $cLang?>" style="margin-right: -38px; text-decoration: none;">
				<img src="../images/srouting.png"  style="<?php echo $routes1?>" border="0" align="absmiddle" />
				<input class="notify1 rotate corner5" value="PRO" disabled="true" />
			</a>&nbsp;
		...
		<td width="65%" height="32px" style="background-image:url(../images/traka.png); border-bottom:1px solid #999" align="right" class="text2" valign="middle">
			<div class="corner5" style="background-color: #387CB0; color: #fff; height: 22px; position: fixed; cursor: pointer; width: 20px; text-align: center; font-size: 20px;" onclick="AlertEvent('2013-03-22 09:40:06.548','SK-0004-AB','alarmpanic', '2061')">+</div>
			<!--div class="corner5"style="background-color: #387CB0; color: #fff; height: 22px; position: fixed; cursor: pointer; margin-left: 25px; width: 20px; text-align: center; font-size: 20px;" onclick="AlertEvent(0)">-</div-->
			<img src="../images/sep.png" border="0" align="absmiddle" />&nbsp;&nbsp;
			...
			<a id="icon-alert" style="position: relative; left: 15px; margin-left: -10px; opacity: 1">
				...
				<input readonly id="alertsNew" class="notify corner5" onclick="ShowHideAlerts()" style="visibility: hidden;" value="0" disabled />
			</a>&nbsp;
			<!--a>
				<div id="alertsNew" class="corner5" style="background-color: Red; color: White; height: 13px; left: 0px; float: left; z-index: 134354; width: 13px; top: 0px; text-align: center;">1</div>
			</a-->
			<a id="icon-mail" style="position: relative; left: 15px; margin-left: -10px; opacity: 0.4">
				...
				<input readonly id="mailNew" class="notify corner5" onclick="ShowHideMail()" style="visibility: hidden;" value="0" disabled />
			</a>&nbsp;
			<img src="../images/sep.png" border="0" align="absmiddle" />&nbsp;&nbsp;
			...
			<div id="top1">
				<div id="topmiddle">
					<div id="topmiddle1" onMouseOver="this.style.opacity = 1; this.style.filter = 'alpha(opacity=100)';" onMouseOut="this.style.opacity = 0.8; this.style.filter = 'alpha(opacity=80)';">
						<iframe id="iFrmS" name="iFrmS" src="../main/NaloziDenes.php"  frameborder="0" scrolling="auto" style="position:absolute;width:100%; top:0px; display:none;"></iframe>
					</div>
					<div id="topmiddle2">
...
<div id="div-enter-zone-name" style="display:none">
	<div align = "center">
 		<table cellpadding="3" width="100%" style="padding-top: 25px;" style="font-size: 11px">
			<tr>
			...
			<tr>
				<td width = "25%" style="font-weight:bold" class ="text2" align="left">Алерт за:</td>
			    <td width = "75%" style="font-weight:bold" class ="text2">
				    <div id="alertINOUT" class="corner5">
				        <input type="checkbox" id="alVlez" name="checkbox" /><label for="alVlez">Влез</label>
				        <input type="checkbox" id="alIzlez" name="checkbox" /><label for="alIzlez">Излез</label>
				    </div>
				</td>
		    </tr>
     		<tr>
				<td width = "25%" style="font-weight:bold" class ="text2" align="left">Група на алерти:</td>
			    <td width = "75%" style="font-weight:bold" class ="text2">
				    <div class="ui-widget" style="height: 25px; width: 100%;">
					    <select id="vozila" style="width: 365px;" class="combobox text2" onchange="OptionsChangeVehicle()">
					    	<option value="0">Одбери опција</option>
					        <option value="1">Едно возило</option>
					        <option value="2">Возила во организациона единица</option>
					        <option value="3">Сите возила во компанијата</option>
					    </select>
					</div>
				</td>
		    </tr>
			<tr id="ednoVozilo" style="display:none;">
		     <td width = "25%" style="font-weight:bold" class ="text2" align="left">Одбери возило:</td>
		     <td width = "75%" style="font-weight:bold" class ="text2">
		     <div class="ui-widget" style="height: 25px; width: 100%;">
		     ...
		     <td width = "25%" style="font-weight:bold" class ="text2" align="left">Одбери орг.единица:</td>
		     <td width = "75%" style="font-weight:bold" class ="text2">
		     <div class="ui-widget" style="height: 25px; width: 100%">
		     <select id="oEdinica" style="width: 365px;" class="combobox text2">
     	     ...
     	     <tr>
		     	<td width = "25%" style="font-weight:bold" class ="text2"  align="left">Emails</td>
		     	<td width = "75%" style="font-weight:bold" class ="text2">
		     		<input id = "txt_emails" class="textboxcalender corner5 text5" type="text" style = "width:365px"></input>
	     		</td>
		     </tr>
		     <tr>
		     	<td width = "25%"></td>	
		     	<td width = "75%" style="font-weight:bold ; " class ="text2"><font color = RED style="font-size = 10px">* За внес на повеќе е-маилови одделувајте со ,Пр: jovan@firma.com,petar@kompanija.com,</font></td>
		     </tr>
		     <tr>
		     	<td width = "25%" style="font-weight:bold" class ="text2"  align="left">SMS</td>
		     	<td width = "75%" style="font-weight:bold" class ="text2"><input id = "txt_phones" class="textboxcalender corner5 text5" type="text" style = "width:365px"></input></td>
		     </tr>
