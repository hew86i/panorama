...
<?php
	...
	$allowedSMSvEmail = 1; // simulira dozvola za ovaa opcija
...
(($clienttypeid == 6 || $allowedSMSvEmail == 1) ? $colspan = 9 : $colspan = 8);
if($clienttypeid == 6 && $allowedSMSvEmail == 1) $colspan = 10;
			...
			<td width = "75%" style="font-weight:bold" class ="text2">
				<div class="ui-widget" style="height: 25px; width: 100%;">
					<select id="comboboxVlez" style="width: 365px">
						<?php
						$str2 = "";
						$str2 .= "select * from pointsofinterest where clientid=" . $clientID ." and type=2 and active = '1' ORDER BY name";
						$dsPP2 = query($str2);
			...
			<td width = "75%" style="font-weight:bold" class ="text2">
				<div class="ui-widget" style="height: 25px; width: 100%;">
					<select id="comboboxIzlez" style="width: 370px">
						<?php
						$str3 = "";
						$str3 .= "select * from pointsofinterest where clientid=" . $clientID ." and type=2 and active = '1' ORDER BY name";
						$dsPP3 = query($str3);
        ...
        open: function() {
		    ...
		    $(function () {
  			...
  			if(isEdit) {
		    	...
		    	if(allowedSMSviaEmail == 1 && (row_array[objID].data.smsviaemail != null)) {
        ...
        buttons: [{
            ...
            click: function(data) {
				...
				var remindme = '';
	 			...
	 			var sendSMS = '';
	 			if(validation.length === 0) sendSMS = smsviaemail + "@" + getMO[get_operator_id(getMO,Number(mobilenoperator))].email;
