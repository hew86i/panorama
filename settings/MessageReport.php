 ...
 <body style="margin:0px 0px 0px 0px; padding:0px 0px 0px 0px" onResize="SetHeightLite()">
  ...
  <?php
   /*function Reverse_Array($array) {
	...
	if ($prEmail == true) {
		$emailClick = "AddEmail(6, '$uid', 'Message report', '$cLang', '$cid')";
...
<div id="icons" style="position: relative; right:8px">
	        ...
	        <div onclick="createPDF('MessageReport', '<?php echo $uid?>', '<?php echo $cid?>')" <?php echo $pdfStyle?>>
		...
		<div onclick="createXls('MessageReport', 'a', '<?php echo $uid?>', '<?php echo $cid?>')" <?php echo $excStyle?>>
