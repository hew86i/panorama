...
function Timepicker() {
	...
	this.regional[''] = { // Default regional settings
		currentText: dic("Reports.Today", lang),
		closeText: dic("Reports.Confirm", lang),
		ampm: false,
		amNames: ['AM', 'A'],
		pmNames: ['PM', 'P'],
		timeFormat: 'hh:mm tt',
		...
		timeText: dic("Reports.Vreme", lang) + ":&nbsp;&nbsp;",
		hourText: dic("Reports.Hour", lang),
		minuteText: dic("Reports.Minutes", lang),
		secondText: 'Second',
		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			var noDisplay = ' style="display:none;"',
				html =	'<div class="ui-timepicker-div" id="ui-timepicker-div-' + dp_id + '"><dl>' +
						'<dt class="ui_tpicker_time_label" style="float:left" id="ui_tpicker_time_label_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '>' + o.timeText + '</dt>' +
						'<dd class="ui_tpicker_time" style="font-weight: bold; color: #2F5185" id="ui_tpicker_time_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '></dd>' +
						'<dt class="ui_tpicker_hour_label" style="padding-top: 10px; float:left; " id="ui_tpicker_hour_label_' + dp_id + '"' +
			...
			if (o.showHour && o.hourGrid > 0) {
				html += '<dd class="ui_tpicker_hour" style="padding-top:10px; padding-left:10px">' +
			...
			html += '<dt class="ui_tpicker_minute_label" style="float:left" id="ui_tpicker_minute_label_' + dp_id + '"' +
					((o.showMinute) ? '' : noDisplay) + '>' + o.minuteText + '</dt>';

			// Minutes
			if (o.showMinute && o.minuteGrid > 0) {
				html += '<dd style="padding-left:10px" class="ui_tpicker_minute ui_tpicker_minute_' + o.minuteGrid + '">' +
