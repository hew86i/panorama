...
<?php
    ...
    $dsv = query("select ca.id, ca.active, ppg.fillcolor color from pointsofinterest ca left outer join pointsofinterestgroups ppg on ca.groupid=ppg.id where ca.active='1' and ca.type=3 and ca.clientid=" . session("client_id") ." " . $str2 . " " . $str3);
