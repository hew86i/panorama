...
<?php
	...
	if($zadrz == "/")
		$zadrz = 0;
	$sqlInsert = "update rnalogheder set name='" . $naslov . "', vehicleid=" . $vozilo . ", driverid1=" . $sofer1 . ", driverid2=" . $sofer2 . ", driverid3=" . $sofer3;
	...
	$sqlInsert1 = "delete from rnalogdetail where hederid=" . $id;
	runsql($sqlInsert1);
