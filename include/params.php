<?php
	...
	//Copyright string
	$CopyrightString = "© 2015 Geonet GPS Solution | Geonet Linux Dev Team";
	...
	{
        $url = 'http://open.mapquestapi.com/directions/v2/route?key=Fmjtd%7Cluubn1682g%2C25%3Do5-90as5f&callback=renderAdvancedNarrative&outFormat=xml&routeType=shortest&timeType=1&enhancedNarrative=false&maxLinkId=10000&shapeFormat=raw&generalize=0&locale=en_GB&unit=k&drivingStyle=2&highwayEfficiency=21.0&from=' . $lat1 . ',' . $lon1 . '&to=' . $lat2 . ',' . $lon2;
	...
	{
        $url = 'http://open.mapquestapi.com/directions/v2/route?key=Fmjtd%7Cluubn1682g%2C25%3Do5-90as5f&callback=renderAdvancedNarrative&outFormat=xml&routeType=fastest&timeType=1&enhancedNarrative=false&maxLinkId=10000&shapeFormat=raw&generalize=0&locale=en_GB&unit=k&drivingStyle=2&highwayEfficiency=21.0&from=' . $lat1 . ',' . $lon1 . '&to=' . $lat2 . ',' . $lon2;
